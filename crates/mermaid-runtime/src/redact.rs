...
//!
//! This module is the single implementation used by both the CLI and the
//! SQLite repositories. Values remain unmodified while executing; cloned
//! arguments, outcomes, labels, and URLs are scrubbed immediately before they
//! cross a persistence or display boundary.
